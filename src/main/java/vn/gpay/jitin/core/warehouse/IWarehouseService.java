...
public interface IWarehouseService extends Operations<Warehouse>{
	...
	public List<Warehouse> findByPContract_Product(Long pcontractid_link, Long productid_link, Long stockid_link, Long skuid_link);
	public List<Warehouse> findByPContract_Product_loan(Long pcontractProduct_id, Long stockid_link, Long skuid_link);
	public List<Warehouse> findByPContract_Product_xuatDieuCHuyen(Long pcontractid_link, Long productid_link, Long stockid_link, Long skuid_link);
